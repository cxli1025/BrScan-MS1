...
file <- "D:/project/04BrIS/hela_single_cell_gradient_samples/20260202_hela_gradient_samples_with_ABCD_samples.csv"
df <- read.csv(file)
...
ggsave(
  file.path(output_path, "Supplementary_Figure9d_HeLa_single_cell_gradient_samples_background_protein_peptide_count.pdf"),
  plot = p,
  width = 4.5,
  height = 2.8,
  family = 'Arial',
