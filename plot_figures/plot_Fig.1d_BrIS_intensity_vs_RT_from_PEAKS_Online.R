...
file <- 'C:/Users/chenxin/Desktop/BrIS_latest/csv/5ng_9_pure_BrIS_peaksonline_searching_results.csv'
data <- read.csv(file)
...
output_path <- file.path(current_path, "Main_Figures", "Figure1")
if (!dir.exists(output_path)) {
  dir.create(output_path, recursive = TRUE)
}
ggsave(
  file.path(output_path, "Fig.1d_BrIS_intensity_vs_RT_from_PEAKS_Online.pdf"),
  plot = p,
  width = 2.6,
  height = 1.43,
  family = 'Arial',
