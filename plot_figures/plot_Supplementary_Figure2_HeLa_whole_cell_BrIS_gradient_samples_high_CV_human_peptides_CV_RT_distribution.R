...
data <- read.csv("D:/project/04BrIS/HeLa_BrIS_gradient_samples_human_peptides_RT_CV.csv")
...
output_path <- file.path(current_path, "Supplementary_Figures", "Figure2")
if (!dir.exists(output_path)) {
  dir.create(output_path, recursive = TRUE)
}
ggsave(
  file.path(output_path, "Supplementary_Figure2_Hela_whole_cell_BrIS_gradient_samples_high_CV_human_peptides_CV_RT_distribution.pdf"),
  plot = p,
  width = 6.0,
  height = 4.4,
  family = 'Arial',
