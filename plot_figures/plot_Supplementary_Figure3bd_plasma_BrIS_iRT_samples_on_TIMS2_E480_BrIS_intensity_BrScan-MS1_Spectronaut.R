...
df1 <- read.csv('Supplementary_Figure3b_plasma_BrIS_iRT_samples_on_TIMS2_BrIS_intensity_BrScan-MS1_Spectronaut.csv')
p1 <- create_intensity_plot(df1, colors, fontsize = unit(6.5, "pt")) +
  scale_y_continuous(breaks = seq(0, 8, 2), limits = c(0, 8))
print(p1)

df2 <- read.csv('Supplementary_Figure3d_plasma_BrIS_iRT_samples_on_E480_BrIS_intensity_BrScan-MS1_Spectronaut.csv')
