...
data1 <- read.csv('Fig.3f_HeLa_whole_cell_BrIS_gradient_samples_BrIS_peptides_RT_CV.csv')
data2 <- read.csv('Fig.3f_HeLa_whole_cell_BrIS_gradient_samples_human_peptides_RT_CV.csv')
data2 <- data2 %>% select(Peptide, CV, Method, Category)
