...
output_path <- file.path(current_path, "Supplementary_Figures", "Figure10")
if (!dir.exists(output_path)) {
  dir.create(output_path, recursive = TRUE)
}

volcano_list <- list(
  "Supplementary_Figure10a_Volcano_MC_vs_HC.pdf" = p1,
  "Supplementary_Figure10b_Volcano_MB_vs_HB.pdf" = p2,
  "Supplementary_Figure10c_Volcano_MI_vs_HI.pdf" = p3
)
...
cairo_pdf(
  file.path(output_path, "Supplementary_Figure10d_diff_proteins_venn_HeLa_MDAMB231.pdf"), 
  width = 2.08, 
  height = 2.08,
  family = "Arial"
  )
