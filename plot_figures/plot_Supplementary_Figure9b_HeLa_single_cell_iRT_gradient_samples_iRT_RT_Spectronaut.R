...
file <- 'D:/project/04BrIS/hela_single_cell_gradient_samples/iRT/RTs.csv'
data <- read.csv(file)
...
ggsave(
  file.path(output_path, "Supplementary_Figure9b_HeLa_single_cell_iRT_gradient_samples_iRT_RT_Spectronaut.pdf"),
  plot = p,
  width = 2.0,
  height = 1.9,
  family = 'Arial',
