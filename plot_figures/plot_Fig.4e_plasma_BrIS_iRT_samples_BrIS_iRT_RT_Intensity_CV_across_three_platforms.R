...
df <- read.csv('D:/project/04BrIS/across_platform/BrIS_iRT_RT_Intensity_CV_across_platforms.csv')
...
ggsave(
  file.path(output_path, "Fig.4e_plasma_BrIS_iRT_samples_BrIS_iRT_RT_Intensity_CV_across_three_platforms.pdf"),
  plot = p,
  width = 3.1,
  height = 1.9,
  family = 'Arial',
